...
class Player:
    ...
    def primary_map_to_enemy_side(self):
        return Player(sc.WINDOW_WIDTH - self.s_x, sc.WINDOW_HEIGHT - self.s_y,
                      sc.WINDOW_WIDTH - self.p_x, sc.WINDOW_HEIGHT - self.p_y, self.p_velocity, False)

    def secondary_map_to_enemy_side(self):
        return Player(sc.WINDOW_WIDTH - self.s_x, sc.WINDOW_HEIGHT - self.s_y, None, None, None, True)
